...
def getRecommendation(cosine_sim):
    df_reviews = pd.read_csv('C:/work/python/Game_RE_Django/board/Datasets/Game_reviews_ALL_Preprocessing_2.csv')
...
def seacrh2(request):
    ...
    Tfidf_matrix = mmread('C:/work/python/Game_RE_Django/board/Models/Tfidf_Game_review01.mtx').tocsr()

    with open('C:/work/python/Game_RE_Django/board\Models/tfidf01.pickle', 'rb') as f:
        Tfidf = pickle.load(f)
    embedding_model = Word2Vec.load('C:/work/python/Game_RE_Django/board/Models/word2vecModel_Game.model')
    key_word = game_input
    ...
    # error = {'error':error}
    game_input = {"game_input":game_input}
